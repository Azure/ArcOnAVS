...
class ArcAddOnRetriever(Retriever):
    instance = None
    _add_on_url = Constant.MGMT_URL + "addons" + "?" + Constant.API_VERSION + "=" + Constant.PREVIEW_API_VERSION_VALUE
    ...
    def retrieve_data(self, customer_resource):
        ...
        add_on_url = self._add_on_url.format(customer_res.subscription_id,
